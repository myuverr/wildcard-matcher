...
const std::vector<ParserTestCase> parser_test_cases = {
    ...
    {"abc", {{{TokenType::LITERAL_SEQUENCE, "abc"}}, {}}, "Simple_literal_string"},
    {"a?c",
     {{{TokenType::LITERAL_SEQUENCE, "a"},
       {TokenType::ANY_CHAR},
       {TokenType::LITERAL_SEQUENCE, "c"}},
      {}},
     "ANY_CHAR_wildcard_surrounded_by_literals"},
    {"a*c",
     {{{TokenType::LITERAL_SEQUENCE, "a"},
       {TokenType::ANY_SEQUENCE},
       {TokenType::LITERAL_SEQUENCE, "c"}},
      {}},
    ...
    {"a\\*c", {{{TokenType::LITERAL_SEQUENCE, "a*c"}}, {}}, "Escaped_asterisk_should_be_a_literal"},
    {"a\\?c", {{{TokenType::LITERAL_SEQUENCE, "a?c"}}, {}}, "Escaped_question_mark_is_a_literal"},
    {"a\\\\c", {{{TokenType::LITERAL_SEQUENCE, "a\\c"}}, {}}, "Escaped_backslash_is_a_literal"},
    {"abc\\",
     {{{TokenType::LITERAL_SEQUENCE, "abc"}}, {{IssueCode::TRAILING_BACKSLASH, 4, std::nullopt}}},
     "Trailing_backslash_should_produce_an_event"},
    {"a\\nc",
     {{{TokenType::LITERAL_SEQUENCE, "anc"}}, {{IssueCode::UNDEFINED_ESCAPE_SEQUENCE, 2, "n"}}},
     "Undefined_escape_sequence_should_produce_an_event"},
    {"*a?b\\*c**d\\",
     {{{TokenType::ANY_SEQUENCE},
       {TokenType::LITERAL_SEQUENCE, "a"},
       {TokenType::ANY_CHAR},
       {TokenType::LITERAL_SEQUENCE, "b*c"},
       {TokenType::ANY_SEQUENCE},
       {TokenType::LITERAL_SEQUENCE, "d"}},
